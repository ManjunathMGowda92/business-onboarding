...
public final class DatabaseKeyConstants {
    ...
    public static final String AI_ENTITY_KEY = "MASTER,V1,AI_ID,<AI_ID>";
    public static final String AUDIT_AI_ENTITY_KEY = "MASTER,V1,AUDIT,AI_ID,<AI_ID>,TIME,<TIMESTAMP>";
    public static final String OU_ENTITY_KEY = "MASTER,V1,OU_ID,<OU_ID>";
    public static final String AUDIT_OU_ENTITY_KEY = "MASTER,V1,AUDIT,OU_ID,<OU_ID>,TIME,<TIMESTAMP>";
    public static final String AI_OU_MAP_ENTITY_KEY = "MASTER,V1,AI_ID,<AI_ID>,OU,<OU_ID>";
    public static final String AUDIT_AI_OU_MAP_ENTITY_KEY = "MASTER,V1,AI_ID,<AI_ID>,OU,<OU_ID>,TIME,<TIMESTAMP>";
    public static final String TRANSACTION_ENTITY_KEY = "COMMON,V1,TXN,<TXN_ID>";
    public static final String AUDIT_TRANSACTION_ENTITY_KEY = "COMMON,V1,AUDIT,TXN,<TXN_ID>,FLOW,<FLOW_TYPE>,TIME,<TIMESTAMP>";
